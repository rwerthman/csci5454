...
\begin{enumerate}
	...
	But for the jogging path problem we need single points within those intervals as the correct output.  We can use the algorithm from question 7 above to find that set $S$ in polynomial time, specifically $O(\,n\,log\,n)$.\\
	\\
